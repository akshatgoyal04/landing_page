+function($){'use strict';var Validator=function(element,options){this.$element=$(element)
  ...
  Validator.DEFAULTS={delay:500,html:!1,disable:!0,custom:{},errors:{match:'Does not match',minlength:'Not long enough'},feedback:{success:'glyphicon-ok',error:'glyphicon-remove'}}
